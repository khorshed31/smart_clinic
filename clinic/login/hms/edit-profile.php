...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($con,"Update users set fullName='$fname',address='$address',city='$city',gender='$gender',age='$age',blood='$blood',phone='$phone',height='$height',width='$width' where userId='".$_SESSION['id']."'");
    if($sql)
    {
                                ...
                                <div class="col-lg-8 col-md-12">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            <?php
                                            $sql=mysqli_query($con,"select * from users where userId='".$_SESSION['id']."'");
                                            ...
                                            <?php } ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="age" class="form-control" required="required"  value="<?php echo htmlentities($data['age']);?>" >
                                                </div>
                                                <select name="blood" class="form-control" required="required" >
                                                    <option value="<?php echo htmlentities($data['blood']);?>"><?php echo htmlentities($data['blood']);?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="width" class="form-control" required="required"  value="<?php echo htmlentities($data['width']);?>" >
                                                </div>
                                                <div class="form-group">
                                                    <label for="fess">
                                                        User Email
