...
if(isset($_POST['submit']))
{
    ...
    $sql = "UPDATE doctors SET  image = '$filename' WHERE doc_id = '$id'";
        ...
        <div class="main-content" >
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Patient | Add Image</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>Image</span>
                                ...
                                <div class="col-lg-8 col-md-12">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <?php $query=mysqli_query($con,"select image from doctors where doc_id='".$_SESSION['id']."'");
                                            while($row=mysqli_fetch_array($query))
                                            {?>
