...
<head>
    ...
    while ($row = mysqli_fetch_array($query)) { ?>
        ...
        <title><?php echo $row['doctorName']; ?> | Add Patient</title>
        <?php
    }
                                        ...
                                        <div class="panel-body">
                                            <form role="form" name="" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="p_name" class="form-control" onChange="getmail(this.value);getgender(this.value);getage(this.value);getphone(this.value)" required="required">
                                                        <option value="">Select Patient</option>
                                                        <?php
                                                        $docid=$_SESSION['id'];
                                                        $ret=mysqli_query($con,"select * from appointment Left join users on users.userId = appointment.userId
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="email" name="patemail" onChange="getgender(this.value);" class="form-control"required="required">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="phone" name="patcontact" onChange="getmail(this.value);" class="form-control"required="required">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="age" name="patage" onChange="getmail(this.value);" class="form-control"required="required">
