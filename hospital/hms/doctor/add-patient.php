...
<form role="form" name="" method="post">
    ...
    <div class="form-group">
        ...
        <select name="p_name" class="form-control" onChange="getmail(this.value); getgender(this.value);" required="required">
...
<!--                Patient Email-->
<!--            </label>-->
<!--            <input type="email" id="email" name="patemail" class="form-control" value="--><?php //echo htmlentities($row['email']);?><!--" placeholder="Enter Patient Email id" required="true" onBlur="userAvailability()">-->
